function [ weights, weighted_score, data_score ] = amen_learn_weights( A, X, community, degrees, M, pnorm, obj_fn, X_Transpose )
...
%     fprintf('community size: %d\n', size(community,2));
    ...
    [weighted_score, ~, data_score] = amen_objective_wrapper(A, X, community, weights, degrees, M, obj_fn, 1, X_Transpose);     
