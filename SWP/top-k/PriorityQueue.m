classdef PriorityQueue < handle
   ...
   methods
       ...
       function [element_data, element_priority] = top(obj)
       ...
       function [element_data,element_priority] = pop(obj)
           ...
           % Now propagate down.
           i = 1;
           maxChild = obj.replacementChildIndex(i);
           while maxChild >= 0
               obj.swap(i, maxChild);
               i = maxChild;
               maxChild = obj.replacementChildIndex(maxChild);
           end
       ...
       function push(obj, element_data, element_priority)
